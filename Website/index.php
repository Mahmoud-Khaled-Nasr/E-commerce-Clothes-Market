		...
		<div id="footer">
			...
			<div class="copy">
				...
				<div class="shell">
					...
					<div class="cl">&nbsp;</div>
					Copyright © 2014 ClothesShop.com All rights reserved. The information contained in ClothesShop.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of ClothesShop.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
